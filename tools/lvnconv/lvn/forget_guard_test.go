...
func TestPersonalDataIsForgettable(t *testing.T) {
	...
	notPersonal := map[string]string{
		// Дом аватарок живёт в ОБОЛОЧКЕ, а забвение — в движке, и по имени
		// класса они не сойдутся никогда. Ключ выбранного лица сносится в
		// LvnForget строкой (см. «аватар»), имя объявлено в LvnAvatars.PickedKey.
		"LvnAvatars.cs": "ключ снимается забвением по имени: движок не видит оболочку",
