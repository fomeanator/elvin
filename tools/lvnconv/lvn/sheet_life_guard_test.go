...
func TestSkipsDoNotMultiply(t *testing.T) {
	const budget = 23 // 22 динамических + 1 статический (05.09: четыре проверки
	// против НАСТОЯЩЕГО сервера — самолечение кэша, доставка событий, защита
	// каталога и смена аккаунта на одном устройстве — пропускаются без
	// собранного бинаря, ровно как смоук рядом с ними.
