    ...
    public sealed partial class WardrobeSheet
    {
        ...
        internal async Task ConfirmAsync()
        {
            ...
            try
            {
                ...
                {
                    // ЛИЦО ЧЕРЕЗ «ВЫБРАТЬ» НЕ ПРОХОДИТ: фишка надевает его сразу
                    // (TR-82), в примерках оси лица не бывает. Страховка на
                    // случай чужой примерки: лицо не покупают, ему тут нечего
                    // делать.
