    ...
    public sealed partial class WardrobeSheet
    {
        ...
        private void RebuildEmotions()
        {
            ...
            foreach (var v in vals)
            {
                ...
                var chip = new Button(() =>
                {
                    // ЛИЦО — ПРИМЕРКА, НЕ ВЕЩЬ. 14.09 пробовали надевать его
                    // насовсем (TR-82 п.3): надетая эмоция утекала в главу —
                    // заполняла ось у команд сценария без эмоции, и лицо героини
                    // прыгало между кадрами. Вернули как было: тап примеряет,
                    // закрытие листа возвращает лицо; в меню — сценарию витрины.
