...
namespace Lvn.UI.Screens
{
    ...
    public sealed partial class PackShopScreen : LvnOverlayScreen, ILvnContentAware
    {
        ...
        /// осталось бы по 90 dp, и цена с бонусом перестали бы читаться.</summary>
        ...
        public PackShopScreen(ILvnAssets assets, bool modal = false)
        {
            ...
            else
            {
                ...
                //
                // …И СПРАВА, СТОЛБИКОМ. Лист во всю ширину резал героиню по
                // грудь: половину витрины занимал прайс-лист, и «магазин»
                // выглядел отдельным приложением поверх игры. Столбик — то же
                // место, что у панелей главной, и героиня остаётся в кадре
                // целиком («переделай ui магазина, сделай его справа» — Илья
                // 08.09).
                _column = true;
                ScreenUi.HubSideSheet(this, sheet);
            }
            Add(sheet);
        ...
        /// собирается обычными карточками темы.</summary>
