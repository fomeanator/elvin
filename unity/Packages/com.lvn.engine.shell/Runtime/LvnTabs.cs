...
namespace Lvn.UI.Screens
{
    ...
    public static class LvnTabs
    {
        ...
        /// <summary>
        /// Список новелл — своя комната витрины НАД главной, а не вид внутри
        /// хаба (схема Ильи 09.09: список сверху, главная в центре, гардероб и
        /// магазин снизу по краям).
        ///
        /// <para>НОМЕР У НЕЁ ЧЕТВЁРТЫЙ, А НЕ ПЯТЫЙ, и это не косметика: номер
        /// страничной вкладки — ещё и индекс в наборе цветов полотна
        /// (<c>TabTints[Clamp(tab, 0, PageCount-1)]</c>). Страничные номера
        /// обязаны идти подряд от нуля; получив пятый при четырёх соседях,
        /// список брал цвет соседа — молча и навсегда. Поймано прогоном
