...
namespace Lvn.UI.Screens
{
    ...
    public sealed partial class BrowseHub : VisualElement, ILvnBrowse, ILvnEntrance, Lvn.UI.ILvnRedress
    {
        ...
        public BrowseHub(BrowseConfig cfg, ILvnAssets assets)
        {
            ...
            _detailDesc.style.color = _text; _detailDesc.style.fontSize = LvnTokens.TextLg;
        ...
        /// <summary>Дверь в комнату списка. Ставит оболочка; пока не
        /// поставлена, кнопка панели открывает список видом внутри хаба.</summary>
        public System.Action OpenTitles;
