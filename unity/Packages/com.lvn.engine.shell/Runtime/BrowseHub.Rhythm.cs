...
namespace Lvn.UI.Screens
{
    ...
    public sealed partial class BrowseHub
    {
        ...
        internal const float CaptionH = 112f;  // минимум; весь ряд растёт под самую высокую подпись

        /// <summary>Минимальный рост плитки и полосы до раскладки текста.
        /// После неё FitShelfCaptions увеличивает их вместе, если нужно.</summary>
