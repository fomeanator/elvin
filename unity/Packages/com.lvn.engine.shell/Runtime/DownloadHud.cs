...
namespace Lvn.UI.Screens
{
    ...
    public sealed partial class DownloadHud : VisualElement
    {
        ...
        // ПОЛОСЫ И КОЛЬЦО ЕДУТ, А НЕ ПРЫГАЮТ. Тик приносит долю раз в 300 мс;
        // ставить её в стиль напрямую — ступенька на каждый тик. Здесь цели,
        // а к целям стили подходят каждый кадр (Glide).
        private float _ringTarget, _ringShown, _barTarget, _barShown, _rowTarget, _rowShown;
        ...
        public DownloadHud()
        {
            ...
            schedule.Execute(Glide).Every(33);   // полосы и кольцо — к цели каждый кадр
