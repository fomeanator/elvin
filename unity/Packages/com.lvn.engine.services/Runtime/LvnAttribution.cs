...
namespace Lvn.Services
{
    ...
    public static class LvnAttribution
    {
        ...
        /// <summary>НЕ ПОДКЛЮЧЁН: ждёт нативного плагина Play Install Referrer. Движок его
        /// не везёт — вход обязан позвать хост, у которого плагин установлен, как и
        /// у платформенного входа.
        ///
        /// Прежнее описание:
