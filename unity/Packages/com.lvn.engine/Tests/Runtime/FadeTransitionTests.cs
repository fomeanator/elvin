...
namespace Lvn.Tests.Runtime
{
    ...
    public class FadeTransitionTests
    {
        ...
        /// надо от <c>WorldStage</c>.
        ///
        /// <para>Оговорка про «-nographics» отсюда УБРАНА: флага в прогоне
        /// больше нет (02.09, страж <c>TestPlayModeRunHasGraphics</c>), и
        /// пиксельные проверки на этой машине идут. Осталась настоящая
        /// причина — путь мимо сцены.</para></remarks>
