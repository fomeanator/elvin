...
namespace Lvn.Tests.Runtime
{
    ...
    public class CompositeFadeTests
    {
        ...
        public IEnumerator ClothesDoNotRevealTheBodyMidFade()
        {
            ...
            // половина — фон (0.5), в среднем ≈0.25. При послойной альфе белое
            // тело просвечивает сквозь одежду и поднимает среднее до ≈0.375.
            // Порог посередине — и он ловит именно рентген, а не «чуть темнее».
