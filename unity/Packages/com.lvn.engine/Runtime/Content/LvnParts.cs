...
namespace Lvn.Content
{
    ...
    public static class LvnParts
    {
        ...
        ///
        /// <para>Ступень — последняя (<see cref="LvnRung.Spare"/>), и это не
        /// формальность. Тот же список, поставленный в ОБЩУЮ очередь, задавил
        /// первый запуск 01.09: сотня картинок каста встала перед главой ноль.
        /// Виноват был не список, а два соседа — неназванный порядок и гейт
