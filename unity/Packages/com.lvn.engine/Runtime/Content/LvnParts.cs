...
namespace Lvn.Content
{
    ...
    public static class LvnParts
    {
        ...
        /// <summary>
        /// НЕ ПОДКЛЮЧЁН: ждёт своей полосы. Список верен, а вот ставить его в
        /// ОБЩУЮ очередь нельзя — проверено на живом первом запуске 01.09:
        /// сотня картинок каста встала перед главой ноль, и агент с фаворитами
        /// вводной не доехали. Ступень у него последняя
        /// (<see cref="LvnRung.Spare"/>), и подключать его надо вместе с
        /// правилом «качать, только когда очередь старших ступеней пуста», а
        /// не просто дописав в конец цикла.
        ///
