...
namespace Lvn.Content
{
    ...
    public static class AssetMemory
    {
        ...
        /// разобрать байты. Шагов два, а мест было ЧЕТЫРЕ — сейвы, загрузчик
        /// содержимого, каталог на диске, сеть, — и одно из них на неудаче
        /// текстуру не уничтожало. Битый или неподдерживаемый файл оставлял в
        /// памяти пустую текстуру при каждой попытке; ошибки нет, лог молчит,
        /// а память тихо растёт ровно у тех, у кого контент побился.</para>
        ///
        /// <para>Уборка здесь и не может быть забыта: неудача возвращает
        /// <c>null</c>, и уничтожать вызывающему нечего.</para>
        /// </summary>
