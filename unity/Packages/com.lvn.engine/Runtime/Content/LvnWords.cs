...
namespace Lvn.Content
{
    ...
    public static class LvnWords
    {
        ...
        /// тот же герой лежит под идентификатором («mira»), а перевод имени
        /// живёт по ключу от идентификатора (<c>actor.mira</c>). Без этой
        /// карты два имени одного человека — разные строки, и сцена с
        /// гардеробом расходились: «Виктория» над репликой и «Mira» в
