...
namespace Lvn.Content
{
    ...
    public partial class ContentLoader
    {
        ...
        public static void NoteAssetUnusable(string url, string why)
        {
            ...
            // Пишем тем же, чем пишет весь загрузчик: след (LvnLog) живёт в
            // Lvn.UI, а этот дом её не видит — и правильно, содержимое не
            // должно зависеть от интерфейса.
            Debug.Log($"[content] файл есть, картинкой не стал: {url} — {why}");
