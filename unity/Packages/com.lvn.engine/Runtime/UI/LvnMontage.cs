...
namespace Lvn.UI
{
    ...
    public static class LvnMontage
    {
        ...
        /// <summary>НЕ ПОДКЛЮЧЁН: ждёт второго заказчика. Схлопывание работ по метке имеет
        /// смысл там, где один элемент просят перерисовать чаще кадра из разных
        /// мест; сегодня такой путь один, и он обходится поколением
        /// (LvnStageClock).
        ///
        /// Прежнее описание:
