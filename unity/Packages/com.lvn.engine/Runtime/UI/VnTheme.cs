...
namespace Lvn.UI
{
    ...
    public class VnTheme
    {
        ...
        /// <summary>То же в миллисекундах — для UITK-переходов сцены.
        ///
        /// <para>ВХОД В СЕКУНДАХ, выход в миллисекундах. Имя говорит про выход,
        /// и это ловушка: <c>MotionMs(220)</c> читается как «двести двадцать
        /// миллисекунд», а даёт двести двадцать СЕКУНД движения. Ошибка не
        /// падает и не логируется — экран просто застывает, и виноватым
        /// выглядит загрузчик. Поэтому у вызовов единица подписана
        /// именованным доводом.</para></summary>
