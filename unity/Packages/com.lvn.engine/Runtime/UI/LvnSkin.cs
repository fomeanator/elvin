...
namespace Lvn.UI
{
    ...
    public static class LvnSkin
    {
        ...
        /// <summary>НЕ ПОДКЛЮЧЁН: решение по облику отложено (658 КБ текстур в каждой сборке
        /// ради семи скинов). Дверь оставлена до ответа: подключать её вместе с
        /// текстурами или выносить облик в контент.
        ///
        /// Прежнее описание:
