...
namespace Lvn.UI
{
    ...
    public static class LvnIcons
    {
        ...
        /// <summary>
        /// НЕ ПОДКЛЮЧЁН: сегодня значок не меняют на месте. Экраны, которым это
        /// могло бы понадобиться (вкладка, значок валюты после смены новеллы),
        /// пересобирают строку целиком. Понадобится тому, кто начнёт менять
        /// иконку без пересборки.
        ///
        /// <para>Сменить сам значок на месте: иконка вкладки, значок валюты
        /// после смены новеллы.</para>
        /// </summary>
