...
|---|---|---|
| Onest | Nikita Kudryashov и участники проекта Onest | OFL 1.1 |
| Inter | The Inter Project Authors | OFL 1.1 |
| Golos Text | The Golos Text Project Authors (ParaType) | OFL 1.1 |
| Literata | The Literata Project Authors | OFL 1.1 |
| Manrope | The Manrope Project Authors | OFL 1.1 |
| Ruslan Display | The Ruslan Display Project Authors | OFL 1.1 |
...
```
Copyright 2011 Oleg Snarsky, Denis Masharov, Vladimir Rabdu, with Reserved Font Name 'Ruslan', 'Ruslan Display'.
