...
//
// Манифест называет оригинал («art/hero_body.png»), а устройство просит
// СТУПЕНЬ: сначала код для видеокарты («…@1440.ktx2»), не вышло — уменьшенную
// картинку («…@1440.png»). Сид вёз оригинал, и на живом каталоге это значило
// вот что: 8,2 МБ одного героя лежат в сборке, а телефон качает его же с
// сервера за 560 КБ — потому что расширения не совпали. Десять мегабайт
// балласта, и первый вход всё равно идёт в сеть.
//
